...
import { getDashboardStats, listScanLogs } from "@/lib/admin/data";

export const metadata: Metadata = { title: "관리자 대시보드 - PUF" };

export default async function AdminDashboardPage() {
  const [user, stats, recent] = await Promise.all([getUserSummary(), getDashboardStats(), listScanLogs("30d", 6)]);
  return (
