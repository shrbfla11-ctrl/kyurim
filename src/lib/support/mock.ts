...
export const faqs: Faq[] = [
  { category: "스캔·인식", q: "스티커가 인식되지 않아요", a: "스티커 전체가 사각형 안에 들어오도록 정면에서 맞추고, 플래시가 꺼진 뒤 찍힐 때까지 10~15cm 거리에서 움직이지 말아 주세요. 주변이 밝으면 패턴이 흐려지므로 그늘을 만들면 인식률이 높아져요." },
  { category: "스캔·인식", q: "플래시가 켜지지 않아요", a: "플래시는 촬영 버튼을 누른 뒤 잠깐만 켜졌다가 자동으로 꺼져요. 일부 구형 기기나 브라우저는 플래시 제어를 지원하지 않아, 밝은 빛을 쬔 스티커를 어두운 곳에서 직접 촬영하셔야 해요." },
...
export const mockInquiries: Inquiry[] = [
  ...
  },
  {
    ...
    subject: "촬영할 때 플래시가 켜지지 않아요",
    preview: "촬영 버튼을 누르면 플래시가 켜진다고 했는데 계속 꺼져 있어요. 아이폰 사파리 사용 중입니다.",
    messages: [{ from: "user", at: "09.02 21:10", body: "촬영 버튼을 누르면 플래시가 켜진다고 했는데 계속 꺼져 있어요. 아이폰 사파리 사용 중입니다." }],
  },
  {
